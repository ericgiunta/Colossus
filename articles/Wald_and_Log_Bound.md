...
#> Analysis converged
#> Run finished in 0.0225 seconds
#> |-------------------------------------------------------------------|
...
#> Analysis converged
#> Run finished in 0.01177 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00726 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.0072 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.0075 seconds
#> |-------------------------------------------------------------------|
