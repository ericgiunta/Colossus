...
#> Analysis converged
#> Run finished in 0.01437 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00687 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.00669 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00722 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.00779 seconds
#> |-------------------------------------------------------------------|
```
