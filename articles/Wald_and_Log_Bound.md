...
#> Analysis converged
#> Run finished in 0.02933 seconds
#> |-------------------------------------------------------------------|
...
#> Analysis converged
#> Run finished in 0.01661 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00838 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.01036 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00906 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.00988 seconds
#> |-------------------------------------------------------------------|
```
