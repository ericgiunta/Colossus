...
#> Analysis converged
#> Run finished in 0.02517 seconds
#> |-------------------------------------------------------------------|
...
#> Analysis converged
#> Run finished in 0.01377 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00854 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.00877 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00915 seconds
#> |-------------------------------------------------------------------|
```
