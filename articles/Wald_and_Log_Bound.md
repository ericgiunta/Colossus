...
#> Analysis converged
#> Run finished in 0.02495 seconds
#> |-------------------------------------------------------------------|
...
#> Analysis converged
#> Run finished in 0.01483 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00703 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.00688 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00736 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.00794 seconds
#> |-------------------------------------------------------------------|
```
