...
#> Run finished in 0.02648 seconds
#> |--------------------------------------------------------------------------------|
...
#> Analysis converged
#> Records Used: 64, Records Removed: 0
#> Run finished in 0.02469 seconds
#> |--------------------------------------------------------------------------------|
```
...
#> Run finished in 0.00774 seconds
#> |--------------------------------------------------------------------------------|
```
...
#> Run finished in 0.00841 seconds
#> |--------------------------------------------------------------------------------|
...
#> Run finished in 0.00903 seconds
#> |--------------------------------------------------------------------------------|
```
