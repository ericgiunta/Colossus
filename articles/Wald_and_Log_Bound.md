...
#> Analysis converged
#> Run finished in 0.02665 seconds
#> |-------------------------------------------------------------------|
...
#> Analysis converged
#> Run finished in 0.02467 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00782 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00837 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.00882 seconds
#> |-------------------------------------------------------------------|
```
