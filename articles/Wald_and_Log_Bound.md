...
#> Run finished in 0.02476 seconds
#> |--------------------------------------------------------------------------------|
...
#> Analysis converged
#> Records Used: 64, Records Removed: 0
#> Run finished in 0.02481 seconds
#> |--------------------------------------------------------------------------------|
```
...
#> Run finished in 0.00846 seconds
#> |--------------------------------------------------------------------------------|
...
#> Run finished in 0.00819 seconds
#> |--------------------------------------------------------------------------------|
```
...
#> Run finished in 0.00909 seconds
#> |--------------------------------------------------------------------------------|
...
#> Run finished in 0.00987 seconds
#> |--------------------------------------------------------------------------------|
```
