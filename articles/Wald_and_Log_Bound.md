...
#> Analysis converged
#> Run finished in 0.02636 seconds
#> |-------------------------------------------------------------------|
...
#> Analysis converged
#> Run finished in 0.02483 seconds
#> |-------------------------------------------------------------------|
```
...
#> Run finished in 0.00809 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.00829 seconds
#> |-------------------------------------------------------------------|
...
#> Run finished in 0.00907 seconds
#> |-------------------------------------------------------------------|
```
