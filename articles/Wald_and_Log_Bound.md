...
#> Run finished in 0.0263 seconds
#> |--------------------------------------------------------------------------------|
...
#> Analysis converged
#> Records Used: 64, Records Removed: 0
#> Run finished in 0.02482 seconds
#> |--------------------------------------------------------------------------------|
```
...
#> Run finished in 0.00793 seconds
#> |--------------------------------------------------------------------------------|
...
#> Run finished in 0.00768 seconds
#> |--------------------------------------------------------------------------------|
```
...
#> Run finished in 0.00827 seconds
#> |--------------------------------------------------------------------------------|
...
#> Run finished in 0.00889 seconds
#> |--------------------------------------------------------------------------------|
```
