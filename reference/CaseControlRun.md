...
`CaseControlRun` uses a formula, data.table, and list of controls to
prepare and run a Colossus matched case-control regression function
...
- conditional_threshold:
  ...
  threshold above which unconditional logistic regression is used to
  calculate likelihoods in a matched group
