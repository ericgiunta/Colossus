...
#    stop()
    ...
    Interpret_Output(e)
    model_control <- list("basic" = FALSE, "log_bound" = TRUE, "alpha" = 0.05, "para_number" = 0, "manual" = TRUE, "maxstep" = 50)
    ...
    Interpret_Output(e1)
    model_control <- list("basic" = FALSE, "log_bound" = TRUE, "alpha" = 0.05, "para_number" = 1, "manual" = TRUE, "maxstep" = 50)
