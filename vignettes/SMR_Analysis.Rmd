...
In this case the estimated contribution of biological sex was 0, so we couldn't find any effect of biological sex on the difference in SMR. Suppose we let both parameter be free and investigated the combined effects. Once again we run the regression, this time with neither parameter held constant.
