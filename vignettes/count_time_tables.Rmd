...
Next, we define the time categories. The only accepted time category for a user defined scale is similar to the age-based calendar scale categories. It is assumed to be provided as a single string or a list with upper and lower limits. While we can technically provide multiple categories, they can always be condensed into a single category similar to the calendary categories.
