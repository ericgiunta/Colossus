...
```{r}
term_number <- c(0, 0, 1)
subterm <- c("loglin", "loglin", "lin")
covariates <- c("dose0", "dose1", "dose2")
model_formula <- "M"
time_start <- "t0"
time_end <- "t1"
event <- "lung"
