...
A formula can be converted to a vector representation by using the `get_form()` function. This transformation is applied automatically when formula are provided to regression functions however. The following expressions are equivalent.
