...
$$
\begin{aligned}
    \lambda(a, r, s) = \exp{ \left(\beta_a \times a + \beta_a \times r + \beta_a \times s \right)}
\end{aligned}
$$
</p>
...
Both options are currently available for both Cox and Poisson regressions.

## Outcome Uncertainty

The same basic theory applies to uncertainty in the outcome, except that there is only one column with realizations. An equivalent of the Frequentist Model Averaging approach has been implemented for logistic regression, to facilitate studies of outcome misclassification.
