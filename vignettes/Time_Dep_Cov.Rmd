...
$$
\begin{aligned}
    Y(x)=\begin{cases} 0 &(x < 0) \\ 1 & ( 6 > x \ge 0) \\ 2 &(12 > x \ge 6) \\ 3 &(x \ge 12) \end{cases}\\
\end{aligned}
$$
</p>
...
$$
\begin{aligned}
    Y(x)=\begin{cases} 1 &(x < 0) \\ 2 & (6 > x \ge 0) \\ 3 &(12 > x \ge 6) \\ 2 &(x \ge 12) \end{cases}\\
\end{aligned}
$$
</p>
...
df_new <- gen_time_dep(
  ...
  c(grt_f), paste(tempfile(), "test_new.csv", sep = ""), func_form,
  nthreads = 1
)
if (system.file(package = "ggplot2") != "") {
