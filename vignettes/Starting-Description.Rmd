...
There are additional variants of these functions which are described in greater detail in the other vignettes, like the matched case-control regression (`vignette("Matched_Case_Control")`), logistic regression (`vignette("Logistic")`), and alternative run options (`vignette("Alt_Run_Opt")`) vignettes.
