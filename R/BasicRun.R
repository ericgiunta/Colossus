...
#' res <- CoxRunMulti(formula, df, control = control, realization_columns = realization_columns, realization_index = realization_index)
...
#' res <- PoisRunMulti(formula, df, control = control, realization_columns = realization_columns, realization_index = realization_index)
