...
#' @param control  list of parameters controlling the convergence, see the [control options vignette](../articles/Control_Options.html) for details
...
#' @param curve_control a list of control options for the likelihood boundary regression. See the [control options vignette](../articles/Control_Options.html) for details.
...
#' @param gradient_control a list of control options for the gradient descent algorithm. If any value is given, a gradient descent algorithm is used instead of Newton-Raphson. See the [control options vignette](../articles/Control_Options.html) for details
...
#' @param model_control  controls which alternative model options are used, see the [control options vignette](../articles/Control_Options.html) for further details
...
#' @param plot_options  list of parameters controlling the plot options, see the [plotting vignette](../articles/Plotting_And_Analysis.html) for different options
...
#' @importFrom stats runif weighted.mean pnorm qnorm approxfun qchisq pchisq time
