...
Note: From versions 1.3.1 to 1.4.1 the expected inputs changed. Regressions are now run with `CoxRun()` and `PoisRun()` and formula inputs. Please see the `vignette("Equation_Expression")` vignette for more details.
