test_that("Coxph lin_err check no error", {
  ...
  control <- list("ncores" = 2, "lr" = 0.75, "maxiter" = 2, "halfmax" = 2, "epsilon" = 1e-6, "deriv_epsilon" = 1e-6, "abs_max" = 1.0, "change_all" = TRUE, "dose_abs_max" = 100.0, "verbose" = 0, "ties" = "breslow", "double_step" = 1)
