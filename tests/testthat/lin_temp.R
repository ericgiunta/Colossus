...
for (alpha_i in 6:6){
   ...
   a_n <- c(0.2462, 5.020,-0.599)
   control <- list( "ncores"=18, 'lr' = 0.75, 'maxiters' = c(10,10), 'halfmax' = 5, 'epsilon' = 1e-4, 'dbeta_max' = 0.5, 'deriv_epsilon' = 1e-3, 'abs_max'=1.0, 'change_all'=TRUE, 'dose_abs_max'=100.0, 'verbose'=4, 'ties'='breslow', 'double_step'=1, 'guesses'=20)
