...
model_control=list( 'basic'=TRUE, 'Log_Bound'=FALSE)
a_n <- c(-0.1,-0.1)
control=list("Ncores"=2,'lr' = 0.75,'maxiters' = c(20,20),'halfmax' = 2,'epsilon' = 1e-6,'dbeta_max' = 0.5,'deriv_epsilon' = 1e-6, 'abs_max'=1.0,'change_all'=TRUE,'dose_abs_max'=100.0,'verbose'=FALSE, 'ties'='breslow','double_step'=1)
...
a_n <- c(0.6553517, 0.4269705)
model_control=list( 'basic'=TRUE, 'Log_Bound'=TRUE)
