...
test_that("Coxph, lin both, curve search", {
  ...
  alpha_list <- c(0.75, 0.5, 1 - 0.683, 0.25, 0.1, 0.05, 0.025, 0.01, 0.005)
  control <- list("ncores" = 2, "lr" = 0.75, "maxiters" = c(10, 10), "halfmax" = 2, "epsilon" = 1e-6, "deriv_epsilon" = 1e-6, "abs_max" = 1.0, "change_all" = TRUE, "dose_abs_max" = 100.0, "verbose" = 0, "ties" = "breslow", "double_step" = 1)

  model_control <- list("basic" = FALSE, "maxstep" = 20, "log_bound" = FALSE, "alpha" = 0.005, "para_num" = 2, "step_size" = 0.5)
  v_lower <- c(1.174131, 0.8706666, 0.5657874, 0.4011341, -0.7499766, -0.7704615, -0.786838, -0.8043551, -0.8154139)
  v_upper <- c(1.702514, 2.0018655, 2.2830783, 2.4149276, 2.8653141, 3.1659819, 3.444758, 3.7898584, 4.0379625)
