test_that("Coxph multidose", {
    ...
    control <- list("ncores"=2,'lr' = 0.75,'maxiter' = 10,'halfmax' = 2,'epsilon' = 1e-6,'dbeta_max' = 0.5,'deriv_epsilon' = 1e-6, 'abs_max'=1.0,'change_all'=TRUE,'dose_abs_max'=100.0,'verbose'=4, 'ties'='breslow','double_step'=1)
