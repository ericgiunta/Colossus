...
interact_them <- function(df,interactions){
    cols <- c()
...
control <- list('lr' = 0.95,'maxiter' = 10,'halfmax' = 5,'epsilon' = 1e-8,'dbeta_max' = 0.1,'deriv_epsilon' = 1e-8,'run'=FALSE,'batch_size'=1000)
