...
List cox_ph_Omnibus_Bounds_transition(IntegerVector& term_n, const StringVector& tform, NumericVector& a_n, IntegerVector& dfc, Ref<MatrixXd> df0, int fir, const string& modelform, List Control, const MatrixXd df_m, NumericVector tu, IntegerVector KeepConstant, int term_tot, NumericVector Strata_vals, VectorXd cens_weight, List model_control, MatrixXd Lin_Sys, VectorXd Lin_Res);
...
List pois_Omnibus_Bounds_transition(MatrixXd& PyrC, IntegerVector& term_n, const StringVector& tform, NumericVector& a_n, IntegerVector& dfc, Ref<MatrixXd> df0, int fir, const string& modelform, List Control, IntegerVector KeepConstant, int term_tot, NumericVector Strata_vals, MatrixXd dfs, List model_control, MatrixXd Lin_Sys, VectorXd Lin_Res);
