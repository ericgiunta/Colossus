...
To properly generate Makevars for linux or MacOS, please run configure_MAKEVAR.sh or modify Colossus/src/Makevars accordingly:
Linux:
-----------------------
PKG_CXXFLAGS=-fopenmp
PKG_LIBS = `$(R_HOME)/bin/Rscript -e "Rcpp:::LdFlags()"` $(LAPACK_LIBS) $(BLAS_LIBS) $(FLIBS) -fopenmp
