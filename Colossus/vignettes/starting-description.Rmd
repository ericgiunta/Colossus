...
names denotes the column names used, Term_n denotes the term numbers, tform denotes the subterm formula, modelform denotes the term formula, fir denotes the "first" term indexed from zero which defaults to 0, and a_n denotes the intial guesses for the parameter values. All of which are assumed to be in the same orders.
